<nav class="grid grid-cols-2 gap-2 bg-gray-100 p-5 lg:grid-cols-3" x-data="{
    ...
    <div class="flex flex-col items-center gap-2 lg:flex-row lg:gap-5">
        ...
        <a class="-ml-5 hidden lg:ml-0 lg:block" href="tel:<?php echo e(env('PHONE_NUMBER')); ?>">
...
<?php /**PATH E:\office_work\anupamatravels.in\src\views/p/navbar.blade.php ENDPATH**/ ?>