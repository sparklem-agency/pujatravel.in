...
<head>
    ...
    <title><?php echo e($__env->yieldContent('title', env('APP_NAME'))); ?></title>
    <link href="/public/css/output.css?v=<?php echo e(env('APP_MODE') === 'prod' ? 1 : time()); ?>" rel="stylesheet">
    ...
    <link rel="shortcut icon" href="<?php echo e(image_asset('favicon.png')); ?>?v=<?php echo e(env('APP_VERSION')); ?>" type="image/x-icon">
    ...
    <footer class="text-surface/75 bg-zinc-50 text-center dark:bg-neutral-700 dark:text-white/75 lg:text-left"
        ...
        <div class="mx-6 py-10 text-center md:text-left">
            <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                <!-- TW Elements section -->
                <div class="">
                    <img src="<?php echo e(image_asset('logo.png')); ?>?v=<?php echo e(env('APP_VERSION')); ?>" class="h-10 mx-auto lg:ml-0"
                        alt="">
                    <p class="mt-5">
                        <?php echo e(env('APP_NAME')); ?> is a premier travel agency based in Northeast India, offering personalized
                        tours
                ...
                <div>
                    ...
                    <?php $__currentLoopData = all_packages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <p class="mb-4 capitalize">
                            <a
                                href="<?php echo e(route('view-package', [
                                    'slug' => $package['slug'],
                                ])); ?>"><?php echo e($package['name']); ?></a>
                        </p>
                ...
                <div>
                    ...
                    <p class="mb-4 flex items-center justify-center md:justify-start">
                        ...
                        <?php echo e(env('ADDRESS')); ?>

                    </p>
                    

                    <a href="tel:<?php echo e(env('PHONE_NUMBER_ONE')); ?>"
                        ...
                        <?php echo e(env('PHONE_NUMBER_ONE')); ?>

                    </a>
                    <a href="tel:<?php echo e(env('PHONE_NUMBER_TWO')); ?>"
                        class="mb-4 flex items-center justify-center md:justify-start">
                        <span class="me-3 [&>svg]:h-5 [&>svg]:w-5">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                <path fill-rule="evenodd"
                        ...
                        <?php echo e(env('PHONE_NUMBER_TWO')); ?>
        ...
        <div class="bg-black/5 p-6 text-center">
            ...
            <a class="font-semibold" href="/"><?php echo e(env('APP_NAME')); ?></a>
        </div>
    </footer>
...
<?php /**PATH E:\office_work\pujatravel.in\src\views/layouts/app.blade.php ENDPATH**/ ?>