<nav class="grid grid-cols-2 gap-2 bg-gray-100 p-5 lg:grid-cols-3" x-data="{
    ...
    <div class="flex flex-col items-center gap-2 lg:flex-row lg:gap-5">
        <h2 class="text-xl font-medium uppercase">AnupamaTravels</h2>

        <a class="-ml-5 block lg:ml-0" href="tel:<?php echo e(env('PHONE_NUMBER')); ?>">
            <?php echo $__env->make('p.icon-button', [
                'label' => '+91 ' . env('PHONE_NUMBER'),
                'prefix' => <<<HTML
                <svg class="size-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
    ...
    <!-- mobile menu -->
    <div class="fixed inset-0 backdrop-blur-lg" @click="show=false" x-show="show"></div>
    <div class="fixed -right-full bottom-0 top-0 min-h-screen w-full max-w-[250px] bg-gray-800 text-white transition-all duration-300 ease-in-out"
        ...
        <div class="space-y-3 divide-y">
            ...
            <a class="block p-3" href="http://">About</a>
            <a class="block p-3" href="http://">Contact</a>
        </div>
    </div>
    ...
    <div class="ml-auto flex w-fit items-center gap-2">
        ...
        <button class="size-10 grid place-items-center rounded-full border-2" type="button" @click="show=true">
...
<?php /**PATH C:\Projects\anupamatravels.in\src\views/p/navbar.blade.php ENDPATH**/ ?>