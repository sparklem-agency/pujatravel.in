...
?>
<form class="bg-grad-1 flex w-full flex-col gap-5 rounded-2xl p-5 py-10" data-aos="flip-right" x-data="{ name: '', phone: '', package: '<?php echo e($c_package); ?>' }"
    @submit.prevent="
    ...
    ">
    <h2 class="text-2xl">Get a booking appointment</h2>
    ...
    <!-- Package Selection -->
    <div>
        <label for="package" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select
            Package</label>
        <select id="package" x-model="package"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            required>
            <?php if($c_package): ?>
                <option value="<?php echo e($c_package); ?>" disabled><?php echo e($c_package); ?></option>
            <?php else: ?>
...
<?php /**PATH E:\office_work\anupamatravels.in\src\views/p/contact-form.blade.php ENDPATH**/ ?>