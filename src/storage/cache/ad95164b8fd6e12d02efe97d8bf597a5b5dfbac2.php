...
<?php $__env->startSection('content'); ?>
    ...
    <div class="p-3 max-w-md mx-auto lg:mt-14" data-aos="fade-up">
        <?php echo $__env->make('p.contact-form', ['current_package' => $package['name']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\office_work\anupamatravels.in\src\views/view-package.blade.php ENDPATH**/ ?>