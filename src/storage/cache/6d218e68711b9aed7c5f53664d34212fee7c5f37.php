    ...
    <div class="absolute top-full mt-2 w-fit divide-y rounded-md bg-white shadow-sm" style="display: none"
        ...
        <?php if(isset($items)): ?>
            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a class="block p-3 whitespace-nowrap capitalize" href="<?php echo e($item['link']); ?>"><?php echo e($item['label']); ?></a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
    </div>
</div>
<?php /**PATH E:\office_work\anupamatravels.in\src\views/p/dropdown.blade.php ENDPATH**/ ?>